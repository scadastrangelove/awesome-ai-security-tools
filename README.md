...
- **[SpendShield](https://github.com/felixpg13-glitch/spendshield)** 🟢 — Python policy & authorization layer for AI-agent **spending**: ALLOW / APPROVAL / DENY against budgets, per-transaction caps and merchant allow/block lists, with signed single-use grants (execution requires the grant) and a tamper-evident audit chain; ships as a library and an MCP server; rail-agnostic (x402, Stripe, wallet). *(★ 2 · updated 2026-09-05)*
