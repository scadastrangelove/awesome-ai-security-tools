...
- **[rule-audit](https://github.com/hermes-labs-ai/rule-audit)** 🟢 — Static analyzer for AI system prompts and agent instructions that reports contradictions, coverage gaps, priority ambiguities, meta-rule paradoxes, and absolute-rule edge cases without an LLM. — **note:** prompt-structure analysis is not runtime enforcement or proof that an agent is safe; findings depend on the analyzer's rule coverage. *(★ 3 · updated 2026-09-19)*
