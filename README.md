...
- **[agent-canary](https://github.com/DorianChn/agent-canary)** 🟢 — Canary tripwires for AI coding agents: inert decoy MCP tools (fake transfer, prod-secrets reader, sudo shell) and planted canary tokens turn any interaction into a zero-false-positive compromise signal, with per-call trace tokens, JSONL audit trail, desktop/webhook alerts, and CI-friendly token scanning. *(MIT · no telemetry · Windows/macOS/Linux)* — **note:** detection-only; decoys never perform real actions by design (see SECURITY.md).
  - **Related:** [agent-gate](https://github.com/DorianChn/agent-gate) · [traceplay](https://github.com/DorianChn/traceplay)
- **[agent-gate](https://github.com/DorianChn/agent-gate)** 🟢 — Python policy gateway for AI-agent and MCP tool calls with deny-by-default controls, parameter-level rules, short-lived HMAC credentials, audit logs, HTTP/MCP proxying, and webhook or Langfuse alerts.
  - **Related:** [agent-canary](https://github.com/DorianChn/agent-canary) · [traceplay](https://github.com/DorianChn/traceplay)
- **[traceplay](https://github.com/DorianChn/traceplay)** 🟢 — Local, deterministic VCR-style recorder and replayer for AI-agent trajectories with tool-call assertions, forbidden-tool checks, reporters, and zero-token CI replay.
  - **Related:** [agent-canary](https://github.com/DorianChn/agent-canary) · [agent-gate](https://github.com/DorianChn/agent-gate)
- **[RepoSieve](https://github.com/DorianChn/reposieve)** 🟢 — Local-first repository context packer for AI coding agents with generated-file filtering, secret-like value detection and redaction, and token-budget controls.
  - **Related:** [agent-canary](https://github.com/DorianChn/agent-canary) · [traceplay](https://github.com/DorianChn/traceplay)
