...
- **[PrivacyScrubber](https://github.com/moxno/privacyscrubber-mcp)** 🟢 — Client-side Zero-Trust Data Sanitization (ZTDS) engine and MCP runtime guard that redacts customer PII, enterprise credentials, and sensitive tokens in local RAM with zero network egress before prompt dispatch to AI agents and LLMs, featuring deterministic reverse-unmasking. *(PrivacyScrubber)* *(★ 2 · updated 2026-09-14)*
  - **Related:** [piighost](https://github.com/Athroniaeth/piighost) · [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard)
