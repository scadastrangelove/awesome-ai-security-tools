    ...
    [
        ...
        ("Runtime Protection & Enforcement", [
            ...
            {"name": "h5i", "repo": "h5i-dev/h5i", "tags": "🟢",
             "desc": "Rust CLI that runs multiple coding agents (Claude Code, Codex) on the same task, each in an isolated git-worktree sandbox, has them peer-review each other, then a neutral verifier replays and tests every candidate before merging the one that passes, with each run versioned in the repo under refs/h5i/* (Apache-2.0).",
